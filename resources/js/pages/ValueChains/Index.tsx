      ...
      >
        <div className="max-w-4xl mx-auto py-8">
          <div className="mb-8">
            ...
            <p className="text-slate-600 mt-1">Sector value chain analysis and structure</p>
          </div>
            ...
            {chains && chains.length > 0 ? (
              chains.map((chain: any) => (
                <Link
                  ...
                  className="block p-6 border rounded-lg hover:border-slate-400 hover:shadow-md transition"
                >
                    ...
                    <div className="flex-1">
                      ...
                      {chain.sector && (
                        <p className="text-sm text-slate-600 mt-1">
                          Sector:{' '}
                          <span className="font-medium text-slate-900">{chain.sector.name}</span>
                        </p>
                      )}
                    </div>
                    <span
                  ...
                  <p className="text-slate-700 line-clamp-2">{chain.thesis}</p>

                  {chain.binding_constraint && (
                    <p className="text-sm text-slate-600 mt-2 italic">
                      Binding: {chain.binding_constraint.substring(0, 80)}...
                    </p>
                  )}
                </Link>
              ))
